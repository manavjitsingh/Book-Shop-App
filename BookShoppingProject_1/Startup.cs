...
namespace BookShoppingProject_1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AppId = "1247897492729578";
                options.AppSecret = "d1c55ef504dc82d546454a8a6ceffbc9";
            });
            services.AddAuthentication().AddGoogle(options =>
            {
                options.ClientId = "1029605635687-pvc450pt60ifbvjmr6ijq953ujjju6a6.apps.googleusercontent.com";
                options.ClientSecret = "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";
            });
